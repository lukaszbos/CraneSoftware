// Arduino Nano pin connections. These you can rewire freely. Each TMC2130 needs its own pins. To reduce the number of pins needed, i have wired EN and DIR to GND.
